...
def formatUnit(){
	if(unitFormat == "Imperial"){
        sendEvent(name: "formatUnit", value: "e", isStateChange: state.force )  
		//state.unit = "e"
        //if(txtEnable == true){log.info "state.unit = $state.unit"}
	}
	if(unitFormat == "Metric"){
        sendEvent(name: "formatUnit", value: "m", isStateChange: state.force )  
		//state.unit = "m"
        //if(txtEnable == true){log.info "state.unit = $state.unit"}
	}
	if(unitFormat == "UK Hybrid"){
        sendEvent(name: "formatUnit", value: "h", isStateChange: state.force )  
		//state.unit = "h"
        //if(txtEnable == true){log.info "state.unit = $state.unit"}
	}
	if(language == "US"){
        sendEvent(name: "formatLanguage", value: "en-US", isStateChange: state.force )  
		//state.languagef = "en-US"
	}
	if(language == "GB"){
        sendEvent(name: "formatLanguage", value: "en-GB", isStateChange: state.force )  
...
def locationCoOrds(){
	...
	sendEvent(name: "latitude", value: polllatitude, isStateChange: state.force )
	sendEvent(name: "longitude", value: polllongitude, isStateChange: state.force )
...
// Weather General Data
            ...
            sendEvent(name: "dayOrNight", value: DN, isStateChange: state.force)
...
// Weather Warnings Data
            ...
            if(device.currentValue('dayOrNight') == "N"){
                ...
                if(weatherWarning == null){sendEvent(name: "weatherWarning", value: "None", isStateChange: state.force )}
				else {sendEvent(name: "weatherWarning", value: weatherWarning, isStateChange: state.force )}	             		
				
                //state.weatherWarningCode = (obs1.daypart[0].qualifierCode[1])
				String weatherWarningCode = (obs1.daypart[0].qualifierCode[1])
                if(weatherWarningCode == null){sendEvent(name: "weatherWarningCode", value: "None", isStateChange: state.force )}
				else {sendEvent(name: "weatherWarningCode", value: weatherWarningCode, isStateChange: state.force )}	}            
            else{	
			...
			if(weatherWarningTommorrow == null){sendEvent(name: "weatherWarningTomorrow", value: "None", isStateChange: state.force )}
			else {sendEvent(name: "weatherWarningTomorrow", value: weatherWarningTommorrow, isStateChange: state.force )}	              		
			...
			if(weatherWarningCodeTomorrow == null){sendEvent(name: "weatherWarningCodeTomorrow", value: "None", isStateChange: state.force )}
			else {sendEvent(name: "weatherWarningCodeTomorrow", value: weatherWarningCodeTomorrow, isStateChange: state.force )}
			...
			if(weatherWarningDATomorrow == null){sendEvent(name: "weatherWarningDATomorrow", value: "None", isStateChange: state.force )}
			else {sendEvent(name: "weatherWarningDATomorrow", value: weatherWarningDATomorrow, isStateChange: state.force )}	              		
			...
			if(weatherWarningCodeDATomorrow == null){sendEvent(name: "weatherWarningCodeDATomorrow", value: "None", isStateChange: state.force )}
			else {sendEvent(name: "weatherWarningCodeDATomorrow", value: weatherWarningCodeDATomorrow, isStateChange: state.force )}
...
// Weather Icons Logic
            ...
            if(device.currentValue('dayOrNight') == "N"){
				...
				sendEvent(name: "forecastTodayIcon", value: "<img src='" + iconURL1 + (obs1.daypart[0].iconCode[1]) + ".png" +"' width='" +iconWidth1 +"' height='" +iconHeight1 +"'>", isStateChange: state.force )
                //state.iconCode2 = (obs1.daypart[0].iconCode[2])
				sendEvent(name: "forecastTomorrowIcon", value: "<img src='" + iconURL1 + (obs1.daypart[0].iconCode[2]) + ".png" +"' width='" +iconWidth1 +"' height='" +iconHeight1 +"'>", isStateChange: state.force )
				//state.iconCode3 = (obs1.daypart[0].iconCode[4])		
				sendEvent(name: "forecastDayAfterTomorrowIcon", value: "<img src='" + iconURL1 + (obs1.daypart[0].iconCode[4]) + ".png" +"' width='" +iconWidth1 +"' height='" +iconHeight1 +"'>", isStateChange: state.force )
				}				
			else{	
				//state.iconCode1 = (obs1.daypart[0].iconCode[0])
				sendEvent(name: "forecastTodayIcon", value: "<img src='" + iconURL1 + (obs1.daypart[0].iconCode[0]) + ".png" +"' width='" +iconWidth1 +"' height='" +iconHeight1 +"'>", isStateChange: state.force )
				//state.iconCode2 = (obs1.daypart[0].iconCode[2])
				sendEvent(name: "forecastTomorrowIcon", value: "<img src='" + iconURL1 + (obs1.daypart[0].iconCode[2]) + ".png" +"' width='" +iconWidth1 +"' height='" +iconHeight1 +"'>", isStateChange: state.force )
				//state.iconCode3 = (obs1.daypart[0].iconCode[4])		
				sendEvent(name: "forecastDayAfterTomorrowIcon", value: "<img src='" + iconURL1 + (obs1.daypart[0].iconCode[4]) + ".png" +"' width='" +iconWidth1 +"' height='" +iconHeight1 +"'>", isStateChange: state.force )
